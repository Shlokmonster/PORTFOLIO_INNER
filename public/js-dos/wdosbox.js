var WDOSBOX = (() => {
  ...
  return function (WDOSBOX) {
    ...
    var asmLibraryArg = {
      ...
      la: ___syscall_fstatat64,
      ka: ___syscall_ftruncate64,
      ...
      ea: ___syscall_mkdir,
      q: ___syscall_open,
      da: ___syscall_readlink,
      ca: ___syscall_recvfrom,
      ba: ___syscall_rename,
      p: ___syscall_rmdir,
      ...
      a: _abort,
      U: _clock_gettime,
      T: destroyMessageSyncSleep,
      S: destroyTimeoutSyncSleep,
      R: emsc_add_frame_line,
      Q: emsc_dump_memory_contents,
      P: emsc_end_frame_update,
      m: emsc_exit_runtime,
      O: emsc_extract_bundle_to_fs,
      l: emsc_getMTimeMs,
      N: emsc_pack_fs_to_bundle,
    ...
    var _get_changes_mtime_ms = (Module['_get_changes_mtime_ms'] = function () {
      return (_get_changes_mtime_ms = Module['_get_changes_mtime_ms'] = Module['asm']['wa']).apply(
        null,
        arguments
      );
    });
    var _zip_from_fs = (Module['_zip_from_fs'] = function () {
      return (_zip_from_fs = Module['_zip_from_fs'] = Module['asm']['xa']).apply(null, arguments);
    });
    var _zip_to_fs = (Module['_zip_to_fs'] = function () {
      return (_zip_to_fs = Module['_zip_to_fs'] = Module['asm']['ya']).apply(null, arguments);
    });
    var _zipfile_to_fs = (Module['_zipfile_to_fs'] = function () {
      return (_zipfile_to_fs = Module['_zipfile_to_fs'] = Module['asm']['za']).apply(
        null,
        arguments
      );
    });
    var _libzip_destroy = (Module['_libzip_destroy'] = function () {
      return (_libzip_destroy = Module['_libzip_destroy'] = Module['asm']['Aa']).apply(
        null,
        arguments
      );
    });
    var _networkConnect = (Module['_networkConnect'] = function () {
      return (_networkConnect = Module['_networkConnect'] = Module['asm']['Ba']).apply(
        null,
        arguments
      );
    });
    var _networkDisconnect = (Module['_networkDisconnect'] = function () {
      return (_networkDisconnect = Module['_networkDisconnect'] = Module['asm']['Ca']).apply(
        null,
        arguments
      );
    });
    var _extractBundleToFs = (Module['_extractBundleToFs'] = function () {
      return (_extractBundleToFs = Module['_extractBundleToFs'] = Module['asm']['Da']).apply(
        null,
        arguments
      );
    });
    var _packFsToBundle = (Module['_packFsToBundle'] = function () {
      return (_packFsToBundle = Module['_packFsToBundle'] = Module['asm']['Ea']).apply(
        null,
        arguments
      );
    });
    var _addKey = (Module['_addKey'] = function () {
      return (_addKey = Module['_addKey'] = Module['asm']['Fa']).apply(null, arguments);
    });
    var _mouseMove = (Module['_mouseMove'] = function () {
      return (_mouseMove = Module['_mouseMove'] = Module['asm']['Ga']).apply(null, arguments);
    });
    var _mouseButton = (Module['_mouseButton'] = function () {
      return (_mouseButton = Module['_mouseButton'] = Module['asm']['Ha']).apply(null, arguments);
    });
    var _mouseSync = (Module['_mouseSync'] = function () {
      return (_mouseSync = Module['_mouseSync'] = Module['asm']['Ia']).apply(null, arguments);
    });
    var _exitRuntime = (Module['_exitRuntime'] = function () {
      return (_exitRuntime = Module['_exitRuntime'] = Module['asm']['Ja']).apply(null, arguments);
    });
    var _runRuntime = (Module['_runRuntime'] = function () {
      return (_runRuntime = Module['_runRuntime'] = Module['asm']['Ka']).apply(null, arguments);
    });
    var _requestPause = (Module['_requestPause'] = function () {
      return (_requestPause = Module['_requestPause'] = Module['asm']['La']).apply(null, arguments);
    });
    var _requestResume = (Module['_requestResume'] = function () {
      return (_requestResume = Module['_requestResume'] = Module['asm']['Ma']).apply(
        null,
        arguments
      );
    });
    var _requestMute = (Module['_requestMute'] = function () {
      return (_requestMute = Module['_requestMute'] = Module['asm']['Na']).apply(null, arguments);
    });
    var _requestUnmute = (Module['_requestUnmute'] = function () {
      return (_requestUnmute = Module['_requestUnmute'] = Module['asm']['Oa']).apply(
        null,
        arguments
      );
    });
    var _requestExit = (Module['_requestExit'] = function () {
      return (_requestExit = Module['_requestExit'] = Module['asm']['Pa']).apply(null, arguments);
    });
    var _getConfigContent = (Module['_getConfigContent'] = function () {
      return (_getConfigContent = Module['_getConfigContent'] = Module['asm']['Qa']).apply(
        null,
        arguments
      );
    });
    ...
    var _dumpMemory = (Module['_dumpMemory'] = function () {
      return (_dumpMemory = Module['_dumpMemory'] = Module['asm']['Sa']).apply(null, arguments);
    });
    var _rescanFilesystem = (Module['_rescanFilesystem'] = function () {
      return (_rescanFilesystem = Module['_rescanFilesystem'] = Module['asm']['Ta']).apply(
        null,
        arguments
      );
    });
    var _pauseExecution = (Module['_pauseExecution'] = function () {
      return (_pauseExecution = Module['_pauseExecution'] = Module['asm']['Ua']).apply(
        null,
        arguments
      );
    });
    var ___stdio_exit = (Module['___stdio_exit'] = function () {
      return (___stdio_exit = Module['___stdio_exit'] = Module['asm']['Va']).apply(null, arguments);
    });
    var ___funcs_on_exit = (Module['___funcs_on_exit'] = function () {
      return (___funcs_on_exit = Module['___funcs_on_exit'] = Module['asm']['Wa']).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_v = (Module['dynCall_v'] = function () {
      return (dynCall_v = Module['dynCall_v'] = Module['asm']['ab']).apply(null, arguments);
    });
