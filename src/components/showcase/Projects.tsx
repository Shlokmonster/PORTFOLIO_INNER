...
const ProjectBox: React.FC<ProjectBoxProps> = ({ icon, title, subtitle, route, iconStyle }) => {
  ...
  return (
    ...
    >
      <div style={styles.projectLinkLeft}>
        <img src={icon} style={Object.assign({}, styles.projectLinkImage, iconStyle)} alt='' />
...
const Projects: React.FC<ProjectsProps> = (props) => {
  return (
    <div className='site-page-content'>
      ...
      <br />
      <p>
        Explore my portfolio of projects below. I've worked on a variety of applications using
        modern web technologies. Each project demonstrates different aspects of my skills and
        expertise in full-stack development — especially in AI, cloud, and automation.
      </p>
      <br />
