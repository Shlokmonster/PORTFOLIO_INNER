          ...
          <div style={styles.windowBorderInner}>
            ...
            >
              <div style={styles.windowHeader}>
                ...
                <p
                  style={windowActive ? {} : { color: colors.lightGray }}
              ...
              <div style={styles.windowTopButtons}>
                <Button icon='minimize' onClick={props.minimizeWindow} />
            ...
            <div onMouseDown={startResize} style={styles.resizeHitbox}></div>
            <div style={styles.bottomBar}>
              ...
              <div style={Object.assign({}, styles.insetBorder, styles.bottomSpacer)} />
              <div style={Object.assign({}, styles.insetBorder, styles.bottomSpacer)} />
              <div style={Object.assign({}, styles.insetBorder, styles.bottomResizeContainer)}>
                <div
                  style={{
                    alignItems: 'flex-end',
                  }}
